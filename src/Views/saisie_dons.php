...
<div class="row justify-content-center">
    <section class="col-lg-8">
        <header class="mb-4">
            <h1 class="h4 fw-bold"><i class="bi bi-gift-fill text-success"></i> <?= $title ?></h1>
            <p class="small">Enregistrez un don reçu</p>
        </header>
        ...
        <article class="card">
            <div class="card-body">
                ...
                <form method="POST" action="<?= BASE_URL ?>/don/<?= isset($edit) ? 'update/'.$id : 'store' ?>">
                    <div class="mb-3">
                        <label for="donateur" class="form-label">Nom du donateur <span class="text-danger">*</span></label>
                        <input type="text" id="donateur" name="donateur" class="form-control" value="<?= htmlspecialchars($old['donateur'] ?? '') ?>" placeholder="Ex: Croix-Rouge" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="row g-2">
                            <div class="col-4">
                                <input type="radio" class="btn-check" name="type_don" id="don_nature" value="nature" <?= (($old['type_don'] ?? '') === 'nature') ? 'checked' : '' ?> required>
                                <label class="btn btn-outline-success w-100" for="don_nature">
                                    <i class="bi bi-basket2-fill d-block fs-3"></i>
                                    <small>Nature</small>
                                </label>
                            </div>
                            <div class="col-4">
                                <input type="radio" class="btn-check" name="type_don" id="don_materiau" value="materiau" <?= (($old['type_don'] ?? '') === 'materiau') ? 'checked' : '' ?>>
                                <label class="btn btn-outline-warning w-100" for="don_materiau">
                                    <i class="bi bi-tools d-block fs-3"></i>
                                    <small>Matériaux</small>
                                </label>
                            </div>
                            <div class="col-4">
                                <input type="radio" class="btn-check" name="type_don" id="don_argent" value="argent" <?= (($old['type_don'] ?? '') === 'argent') ? 'checked' : '' ?>>
                                <label class="btn btn-outline-primary w-100" for="don_argent">
                    ...
                    <div class="mb-3">
                        <label for="ville_id" class="form-label">Ville bénéficiaire <small class="text-muted">(optionnel)</small></label>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?= BASE_URL ?>/don" class="btn btn-secondary">
